...
@Config
@Autonomous(name = "Near Park (Red)")
public class NearParkRed extends LinearOpMode {
    public static String PATH = JSONParsingUtils.stringFromResource("/NearParkRed.json");
